                ...
                stage('OWASP') {
                    steps {
                        dependencyCheck additionalArguments: '''--scan './' \
                            ...
                            publishHTML([allowMissing: true, alwaysLinkToLastBuild: true, icon: '', keepAll: true, reportDir: './', reportFiles: 'dependency-check-report.html', reportName: 'dependency check test HTML Report', reportTitles: ''])
